...
if res is 'y' or res is 'Y':
    ...
    download_file_from_google_drive('1SNJqvnW6Mm9DO2AW66bURN1CqztFw7Ph', 'checkpoint/Multi/model.ckpt.data-00000-of-00001')
    download_file_from_google_drive('1z-X4_vLHyRVUtz5PWesY3DcCvET7f38I', 'checkpoint/Multi/model.ckpt.meta')
